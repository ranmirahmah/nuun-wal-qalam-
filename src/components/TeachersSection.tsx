...
export function TeachersSection() {
  const teachers: Teacher[] = [
    ...
    },
    {
      ...
      education: "PhD in Islamic History",
      experience: "15 years",
      specialties: ["Early Islamic History", "Civilization Studies"],
      image: ""
    },
    {
      ...
      experience: "22 years",
      specialties: ["Quran Memorization", "Tajweed"],
      image: ""
    },
    {
      name: "Ms. Sarah Ahmed",
      ...
      experience: "12 years",
      specialties: ["Creative Writing", "Literature"],
      image: ""
    }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Meet our dedicated educators who combine deep Islamic knowledge with
            academic excellence to guide and inspire our students.
          </p>
        </div>
